...
main = tkinter.Tk()
main.title("A Generic Model to Analyze and Predict Brain Tumor from MRI And CT Medical Images Using Deep Learning") #designing main screen
...
def predict():
    ...
    ftp.login("vitdrivehq2018", "vit2216487")
    ftp.prot_p()
    name = imagelist.get()
...
font = ('times', 16, 'bold')
title = Label(main, text='A Generic Model To Analyse And Predict Brain Tumor From MRI And CT Medical Images Using Deep Learning')
